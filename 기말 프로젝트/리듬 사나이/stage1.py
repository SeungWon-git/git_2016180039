...
class Stage1:
    def __init__(self,health):
        ...
        global answer, ask, count1, count2, count_up
        answer = False
        ask = False
        count1 = 0
        count2 = 0
        ...
        global whistle_num, progress, intro, practice, correct, time, key, goal, p_key,\
            me_shout_time, speed, check, shout_randidx, last_speak, ask_, m_intro, time_, answer_time
        intro = True
        practice = True
        whistle_num = 5
        progress = 0
        ...
        intro_dialog = [gfw.image.load('res/intro_dialog-1.png'),gfw.image.load('res/intro_dialog-2.png'),\
                        ...
                        gfw.image.load('res/intro_dialog-9.png')]
        m_intro_dialog = [gfw.image.load('res/dialog_lastspeak.png'),gfw.image.load('res/dialog_gw.png'),\
                          gfw.image.load('res/dialog_lastp1.png'),gfw.image.load('res/dialog_lastp2.png'),\
                          gfw.image.load('res/dialog_lastp3.png')]

        global pt, pt_sorry,pt_angry, trainer, whistle, shout, number, healthbar_blue, healthbar_red, \
    ...
    def update(self):
        global time, frame, frame_, speed, check, correct, p_key, key, practice,\
            last_speak, goal, progress, count1, count2, intro, whistle_num, time_, m_intro
        time += gfw.delta_time
